...
insert into Canton(numeroCanton,numeroProvincia,nombre) values(5,1,'Aserri'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(6,1,'Mora'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(7,1,'Goicoechea'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(8,1,'Santa Ana'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(9,1,'Alajuelita'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(10,1,'Vasquez de Coronado'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(11,1,'Acosta'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(12,1,'Tibas'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(13,1,'Moravia'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(14,1,'Montes de Oca'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(15,1,'Turrubares'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(16,1,'Dota'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(17,1,'Curridabat'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(18,1,'Perez Zeledon'); 
insert into Canton(numeroCanton,numeroProvincia,nombre) values(19,1,'Leon Cortez'); 
...
insert into Canton(numeroCanton,numeroProvincia,nombre) values(6,5,'Cañas'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(11,18,1,'El Páramo'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(13,2,2,'Peñas Blancas'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(2,14,2,'Caño Negro'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(1,4,3,'Juan Viñas'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(6,2,4,'San Jose de la Montaña'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(5,10,4,'Cureña'); 
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(1,1,5,'Liberia'); 
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(2,1,5,'Cañas Dulces'); 
...
insert into Distrito(numeroDistrito,numeroCanton,numeroProvincia,nombre) values(1,6,5,'Cañas'); 
...
INSERT INTO persona VALUES 
		(112341111, 'Oscar', 'Arias', 'Mora', '1995-09-13', 'Lomas del Zurqui',
		'oscar.ariasmora@ucr.ac.cr',1,1,1, 'Sin Observaciones', '2017-03-01' ),
		(212342222, 'Ana', 'Rojas', 'Rojas', '1980-09-12', 'Lomas del Zurqui', 
		'ana.rojas@ucr.ac.cr',3,2,7, 'Sin Observaciones', '2017-05-02' ),
		(312343333, 'Juan', 'Valdez', 'Quintos', '1965-09-04', 'Lomas', 
		'juan.vladez@ucr.ac.cr',6,1,1, 'Sin Observaciones', '2017-09-03' ),
		(412344444, 'Fabiola', 'Ortega', 'Mondragon','1988-09-27', 'Moravia', 
		'fabiola.ortegamongragon@ucr.ac.cr',7,10,2, 'Sin Observaciones', '2017-11-04' ),
		(512345555, 'Valentina', 'Del Valle', 'Aguilar', '1979-09-13', 'Zurqui', 
		'valentina.delvalle@ucr.ac.cr',5,4,1, 'Sin Observaciones', '2017-11-04' ),
		(612346666, 'Rafael', 'Corrales', 'Marcos', '1996-11-22', 'Villangel', 
		'rafael.corrales@ucr.ac.cr',7,2,2, 'Sin Observaciones', '2017-11-04' ),
		(712347777, 'Davidson', 'Smith', 'Harley', '1999-10-13', 'Puerto', 
		'davidson.smith@ucr.ac.cr',4,1,5, 'Sin Observaciones', '2017-11-04' ),
		(812348888, 'Bjork', 'Gur', 'Bol', '1978-09-13', 'Somewhere', 
		'bjork.gur@ucr.ac.cr',2,2,2, 'Sin Observaciones', CURRENT_TIMESTAMP );

INSERT INTO telefonoPersona VALUES
		(112341111, 22345050),
		(212342222, 40679999),
		(612346666, 60783459),
		(712347777, 76908658),
...
INSERT INTO empleado VALUES 
		(312343333, 'jvaldez', 1357, 290000, NULL, '11 a 9', 812348888, 'Asistente Cocina' ),
		(612346666, 'rcorrales', 1234, 280000, NULL, '11 a 2', 812348888, 'Cocinero'),
		(812348888, 'bgur', 8888, 368000, NULL, '4 a 10', NULL, 'Administrador');

INSERT INTO contactoEmergencia VALUES 
		(312343333, 'El Papa', 42854285),
		(612346666, 'La Mama', 22222828),
		(812348888, 'Abuela', 88888282);

INSERT INTO cliente VALUES
		(112341111, 124, 0.3, 20000),
		(212342222, 5, 0.1, 5000),
		(412344444, 0, 0.0, 0),
		(512345555, 0, 0.0, 0),
		(712347777, 50, 0.1, 10000);

EXEC creaMesas;

INSERT INTO reserva VALUES 
	(1,3,'2017-12-14 18:30:00','Oscar','No comen carne'),
	(1,4,'2017-12-14 19:15:00','Ana','VIP'),
	(2,5,'2017-12-14 20:45:00','Luis','Vienen con hambre'),
	(1,1,'2017-12-14 20:45:00','Gustavo','Tienen ninos');

INSERT INTO orden VALUES 
	('2017-12-14 20:45:00',1000,312343333,1,1),
	('2017-12-14 18:45:00',1001,312343333,1,2),
	('2017-12-14 19:45:00',1002,312343333,1,2),
	('2017-12-14 20:45:00',1003,312343333,1,2),
	('2017-12-14 20:45:00',9000,812348888,1,3),
	('2017-12-14 19:45:00',1004,312343333,1,4),
	('2017-12-14 20:45:00',1005,312343333,1,4),
	('2017-12-14 18:45:00',1006,312343333,1,5),
	('2017-12-14 19:45:00',1007,312343333,1,5),
	('2017-12-14 20:45:00',1008,312343333,1,5),
	('2017-12-14 18:45:00',1009,612346666,2,1),
	('2017-12-14 19:45:00',1010,612346666,2,1),
	('2017-12-14 20:45:00',1011,612346666,2,1),
	('2017-12-14 20:45:00',9001,812348888,2,2),
	('2017-12-14 20:45:00',1012,612346666,2,3),
	('2017-12-14 19:45:00',1013,612346666,2,4),
	('2017-12-14 20:45:00',1014,612346666,2,4),
	('2017-12-14 21:45:00',1015,612346666,2,4),
	('2017-12-14 19:45:00',1016,612346666,2,5),
	('2017-12-14 20:45:00',1017,612346666,2,5);


INSERT INTO platillo VALUES
	--'BEBIDA'
	(101,'Coca Cola','Se compra','Fresco Azucar',1500,700,'Bebida'),
	(102,'Imperial','Se compra','Bebida Alcoholica',2000,750,'Bebida'),
	(103,'Pilsen','Se compra','Bebida Alcoholica',2000,750,'Bebida'),
	(104,'Vino','Se compra','Bebida Alcoholica',3000,2000,'Bebida'),
	(105,'Guayabana','Se compra','Fresco Natural',1000,200,'Bebida'),
	
	--'ENTRADA'
	(201,'Sopa del dia','Ideas del chef','Cacero',3500,920,'Entrada'),
	(202,'Pati','Se compra','Caceror',1500,800,'Entrada'),

	--'PLATO FUERTE'
	(301,'Rice and Beans','Se revuelven','Plato tipico caribeno',4500,1340,'Plato Fuerte'),
	(302,'Rondon','Se hace sopa','Deliciosa sopa de mariscos',6000,1780,'Plato Fuerte'),
	(303,'Sandwich de Negro','Se hace sandiwch','Especialidad del Caribe Costarricense',5500,1400,'Plato Fuerte'),
	(304,'Camarones Caribenos','Se pescan','Recomedacion del Chef',6500,2050,'Plato Fuerte'),

	--'POSTRE'
	(401,'Helado Vainilla','Se compra','Tipico Helado',1500,400,'Postre'),
	(402,'Flan de Coco','Se compra','Delicioso Flan',1500,400,'Postre'),

	--'ADICIONALES'
	(501,'Papas Fritas','Se prepara','Frescas papas francesas',1500,300,'Adicionales'),
	(502,'Chips de Camote','Se prepara','Hechos en casa',1500,390,'Adicionales'),
	(503,'Ensalada Verde','Se compra','Ensalada Cesar',1500,400,'Adicionales');


INSERT INTO ordenContienePlatillo VALUES 
	--ORDEN 1000
	('2017-12-14 20:45:00',312343333,1,1,101,4,0),
	('2017-12-14 20:45:00',312343333,1,1,302,1,0),
	('2017-12-14 20:45:00',312343333,1,1,401,1,0),
	('2017-12-14 20:45:00',312343333,1,1,503,1,0),
	
	--ORDEN 1001
	('2017-12-14 18:45:00',312343333,1,2,101,2,0),
	('2017-12-14 18:45:00',312343333,1,2,103,2,0),
	
	--ORDEN 1002
	('2017-12-14 19:45:00',312343333,1,2,201,1,0),
	
	--ORDEN 1003
	('2017-12-14 20:45:00',312343333,1,2,301,2,0),
	('2017-12-14 20:45:00',312343333,1,2,302,2,0),
	('2017-12-14 20:45:00',312343333,1,2,304,3,0),
		
	--ORDEN 9000
	('2017-12-14 20:45:00',812348888,1,3,101,2,0),
	('2017-12-14 20:45:00',812348888,1,3,301,2,0),
		
	--ORDEN 1004
	('2017-12-14 19:45:00',312343333,1,4,101,2,0),
	('2017-12-14 19:45:00',312343333,1,4,102,1,0),
	('2017-12-14 19:45:00',312343333,1,4,103,1,0),
	('2017-12-14 19:45:00',312343333,1,4,104,1,0),
	('2017-12-14 19:45:00',312343333,1,4,202,2,0),
	('2017-12-14 19:45:00',312343333,1,4,302,1,0),
	('2017-12-14 19:45:00',312343333,1,4,303,1,0),
	('2017-12-14 19:45:00',312343333,1,4,304,1,0),
	('2017-12-14 19:45:00',312343333,1,4,401,1,0),
	('2017-12-14 19:45:00',312343333,1,4,501,1,0),
	('2017-12-14 19:45:00',312343333,1,4,502,1,0),
		
	--ORDEN 1005
	('2017-12-14 20:45:00',312343333,1,4,202,2,0),
	('2017-12-14 20:45:00',312343333,1,4,402,1,0),
		
	--ORDEN 1006
	('2017-12-14 18:45:00',312343333,1,5,104,2,0),
	('2017-12-14 18:45:00',312343333,1,5,402,2,0),
		
	--ORDEN 1007
	('2017-12-14 19:45:00',312343333,1,5,101,2,0),
	('2017-12-14 19:45:00',312343333,1,5,202,1,0),
	('2017-12-14 19:45:00',312343333,1,5,502,1,0),
		
	--ORDEN 1008
	('2017-12-14 20:45:00',312343333,1,5,104,1,0),
	('2017-12-14 20:45:00',312343333,1,5,304,1,0),
		
	--ORDEN 1009
	('2017-12-14 18:45:00',612346666,2,1,101,1,0),
	('2017-12-14 18:45:00',612346666,2,1,501,1,0),
		
	--ORDEN 1010
	('2017-12-14 19:45:00',612346666,2,1,103,1,0),
	('2017-12-14 19:45:00',612346666,2,1,201,1,0),
		
	--ORDEN 1011
	('2017-12-14 20:45:00',612346666,2,1,102,1,0),
	('2017-12-14 20:45:00',612346666,2,1,301,1,0),
	('2017-12-14 20:45:00',612346666,2,1,401,1,0),
		
	--ORDEN 9001
	('2017-12-14 20:45:00',812348888,2,2,102,1,0),
	('2017-12-14 20:45:00',812348888,2,2,501,1,0),
		
	--ORDEN 1012
	('2017-12-14 20:45:00',612346666,2,3,104,2,0),
	('2017-12-14 20:45:00',612346666,2,3,303,1,0),
		
	--ORDEN 1013
	('2017-12-14 19:45:00',612346666,2,4,102,2,0),
	('2017-12-14 19:45:00',612346666,2,4,302,1,0),
	('2017-12-14 19:45:00',612346666,2,4,402,1,0),
		
	--ORDEN 1014
	('2017-12-14 20:45:00',612346666,2,4,102,2,0),
	('2017-12-14 20:45:00',612346666,2,4,202,1,0),
	('2017-12-14 20:45:00',612346666,2,4,302,1,0),
		
	--ORDEN 1015
	('2017-12-14 21:45:00',612346666,2,4,101,1,0),
	('2017-12-14 21:45:00',612346666,2,4,301,1,0),
	('2017-12-14 21:45:00',612346666,2,4,501,1,0),
		
	--ORDEN 1016
	('2017-12-14 19:45:00',612346666,2,5,101,4,0),
	('2017-12-14 19:45:00',612346666,2,5,302,1,0),
		
	--ORDEN 1017
	('2017-12-14 20:45:00',612346666,2,5,105,1,0),
	('2017-12-14 20:45:00',612346666,2,5,401,1,0),
	('2017-12-14 20:45:00',612346666,2,5,501,1,0);
...
UPDATE PERSONA 
SET identificacion = 900000009
WHERE Apellido1 = 'Arias';
*/
